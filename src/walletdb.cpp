...
bool CWalletDB::WriteBestBlock(const CBlockLobitcoinrealr& lobitcoinrealr)
{
    nWalletDBUpdated++;
    return Write(std::string("bestblock"), lobitcoinrealr);
}

bool CWalletDB::ReadBestBlock(CBlockLobitcoinrealr& lobitcoinrealr)
{
    return Read(std::string("bestblock"), lobitcoinrealr);
}
