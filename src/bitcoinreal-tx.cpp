...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitcoin Real Core bitcoinreal-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinreal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinreal transaction") + "\n" +
                               "  bitcoinreal-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinreal transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinreal transaction
