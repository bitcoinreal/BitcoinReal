...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0000e5700d3b1cd0392a0cf85f60eba06ed2e9656d693bc25e9efe86f0bbea49"));
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1540321102 ;  // Sat, 20 Oct 2018 07:12:23 GMT
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 96030;
		...
		*/
        ...
        hashGenesisBlock = genesis.GetHash();
		assert(hashGenesisBlock == uint256("0000e5700d3b1cd0392a0cf85f60eba06ed2e9656d693bc25e9efe86f0bbea49"));
		assert(genesis.hashMerkleRoot == uint256("1f25f27036f37b24802c498e8334360eaa445aad0a81b93436fe017ffa270b64"));
		...
		vSeeds.push_back(CDNSSeedData("sa.bitcoinreal.org", " sa.bitcoinreal.org")); // South Amercia
		vSeeds.push_back(CDNSSeedData("aus.bitcoinreal.org", " aus.bitcoinreal.org")); // Australia
