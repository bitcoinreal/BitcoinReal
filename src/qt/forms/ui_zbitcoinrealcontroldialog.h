...
public:
    ...
    void retranslateUi(QDialog *ZBitcoinrealControlDialog)
    {
        ...
        labelZCatocoin->setText(QApplication::translate("ZBitcoinrealControlDialog", "zBitcoinreal", Q_NULLPTR));
        labelZCatocoin_int->setText(QApplication::translate("ZBitcoinrealControlDialog", "0", Q_NULLPTR));
