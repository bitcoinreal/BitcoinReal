...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoinreal Core"),
     ...
     * override -datadir in the bitcoinreal.conf file in the default data directory
     * (to be consistent with bitcoinreald behavior)
     */
    if (dataDir != getDefaultDataDirectory())
