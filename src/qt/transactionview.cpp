                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BitconReal from zBitconReal"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBitconReal"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBitcoinReal));
