...
namespace GUIUtil
{
	...
	void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
	{
		...
		widget->setPlaceholderText(QObject::tr("Enter a BitcoinReal address (e.g. %1)").arg("BeTykK6PWaiezrNK2vjcTJtcfiA2krta1t"));
	...
	{
		// return if URI is not valid or is no BitcoinReal: URI
	...
	{
		// Convert bitcoinreal:// to bitcoinreal:
		//
		//    Cannot handle this later, because bitcoinreal:// will cause Qt to see the part after // as host,
	...
	void openConfigfile()
	{
		...
		/* Open bitcoinreal.conf with the associated application */
	...
	*/
	...
	{
		return GetSpecialFolderPath(CSIDL_STARTUP) / "BitcoinReal.lnk";
	}

	bool GetStartOnSystemStartup()
	{
		// check for BitcoinReal.lnk
	...
	{
		return GetAutostartDir() / "bitcoinreal.desktop";
	}
	...
	bool SetStartOnSystemStartup(bool fAutoStart)
	{
		if (!fAutoStart)
			...
			if (!optionFile.good())
				return false;
			// Write a bitcoinreal.desktop file to the autostart directory:
			optionFile << "[Desktop Entry]\n";
			optionFile << "Type=Application\n";
			optionFile << "Name=BitcoinReal\n";
...
#include <CoreServices/CoreServices.h>
	...
	LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
	{
		// loop through the list of startup items and try to find the bitcoinreal app
	...
	bool SetStartOnSystemStartup(bool fAutoStart)
	{
		...
		if (fAutoStart && !foundItem) {
			// add bitcoinreal app to startup item list
