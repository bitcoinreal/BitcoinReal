...
/* BitcoinReal GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BitcoinReal"
#define QAPP_ORG_DOMAIN "bitcoinreal.org"
#define QAPP_APP_NAME_DEFAULT "BitcoinReal-Qt"
#define QAPP_APP_NAME_TESTNET "BitcoinReal-Qt-testnet"
