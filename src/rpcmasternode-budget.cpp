...
Value mnbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a Bitcoin Real initiative\n"
            "  vote-alias         - Vote on a Bitcoin Real initiative\n"
            "  vote               - Vote on a Bitcoin Real initiative/budget\n"
...
Value preparebudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            ...
            "5. \"bitcoinreal-address\":   (string, required) Bitcoin Real address to send payments to\n"
...
Value getbudgetprojection(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) Bitcoin Real address of payment\n"
