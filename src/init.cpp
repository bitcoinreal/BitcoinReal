...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-backupzcatocoin=<n>", strprintf(_("Enable automatic wallet backups triggered after each zBitcoinReal minting (0-1, default: %u)"), 1));
...
// ********************************************************* Step 8: load wallet
    ...
    if (fDisableWallet) {
        ...
        bool fEnableZCatocoinBackups = GetBoolArg("-backupzbitcoinreal", true);
