...
// ********************************************************* Step 8: load wallet
    ...
    if (fDisableWallet) {
        ...
        if (fFirstRun) {
            ...
            pwalletMain->SetBestChain(chainActive.GetLobitcoinrealr());
        }
        ...
        if (GetBoolArg("-rescan", false))
            ...
            if (walletdb.ReadBestBlock(lobitcoinrealr))
                pindexRescan = FindForkInGlobalIndex(chainActive, lobitcoinrealr);
            else
                pindexRescan = chainActive.Genesis();
        }
