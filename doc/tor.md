TOR SUPPORT IN BitcoinReal
=======================

It is possible to run BitcoinReal as a Tor hidden service, and connect to such services.
...
Run BitcoinReal behind a Tor proxy
----------------------------------

The first step is running BitcoinReal behind a Tor proxy. This will already make all
...
```
./bitcoinreald -proxy=127.0.0.1:9050
```

Run a BitcoinReal hidden server
-------------------------------
...
-externalip=X   You can tell bitcoinreal about its publicly reachable address using
                ...
                /var/lib/tor/bitcoinreal-service/hostname. Onion addresses are given
