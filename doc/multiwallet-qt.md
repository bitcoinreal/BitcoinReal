...
In order to support loading of multiple wallets in bitcoinreal-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinreal.cpp.
...
Changes to bitcoinreal.cpp
----------------------
bitcoinreal.cpp is the entry point into bitcoinreal-qt, and as such, will require some minor modifications to provide hooks for
