Contributing to BitcoinReal
============================

The BitcoinReal project operates an open contributor model where anyone is
...
The following applies to code changes to the BitcoinReal project, and is not to be
confused with overall BitcoinReal Network Protocol consensus changes.

Whether a pull request is merged into BitcoinReal rests with the project merge
...
The project leader is the release manager for each BitcoinReal release.
