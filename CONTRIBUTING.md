Contributing to BitcoinReal Core
============================

The BitcoinReal Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitcoinReal Core project, and is not to be
confused with overall BitcoinReal Network Protocol consensus changes.

Whether a pull request is merged into BitcoinReal Core rests with the project merge
...
Patches that change BitcoinReal consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitcoinReal consensus, it must have been
...
The project leader is the release manager for each BitcoinReal Core release.
