...
#   c) node1 mines 32 blocks, so now node 0 has 60001br, node 1 has 4250br, node2 has none.
#   d) node0 sends 601 br to node2, in two transactions (301 br, then 300 br).
